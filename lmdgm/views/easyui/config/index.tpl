        ...
        <div style="padding:20px 20px 40px 80px;">
            <form id="form1" method="post">
                <table>
                    <tr>
                        <td>标识：</td>
                        <td><input name="Code" class="easyui-validatebox" maxlength="10" required="true" /></td>
                    </tr>
                    <tr>
                        <td>配置内容(JSON)：</td>
                        <td><textarea name="Config" class="easyui-validatebox" validType="length[0,200]"></textarea></td>
                    </tr>
                </table>
            </form>
        </div>
