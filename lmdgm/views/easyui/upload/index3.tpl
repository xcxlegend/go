...
<body class="easyui-layout" style="text-align:left">
    ...
    <div region="west" border="false" split="true" title="目录" tools="#toolbar" style="width:200px;padding:5px;">
        ...
        <ul id="tree" class="easyui-tree" url="/rbac/upload/dir">
        </ul>
        <!-- <li class="tree-no-li">
                <div id="node_root" data-isdir="true" data-loaded="true" data-path="" class="tree-node" style="cursor: pointer;"><span class="tree-icon tree-folder"></span><span class="tree-title">./</span></div>
            </li> -->
        </ul>
    </div>
                ...
                <div style="padding:10px 60px 20px 60px">
                    <form id="upload" method="post" action="/rbac/upload/post" enctype="multipart/form-data">
                        <table cellpadding="5">
                            <tr>
                                <td>选择目录:</td>
                                <td><input readonly="" id="form-path" class="easyui-textbox" type="text" name="path" data-options="required:true"></input>
                                </td>
                            </tr>

                            <tr>
                                <td>上传文件:</td>
                                <td><input type="file" class="easyui-textbox" name="file" data-options="required:true"></input>
                                </td>
                            </tr>

                            <tr>
                                <td>上传自动是否解压: (仅支持 .zip 文件)</td>
                                <td><input type="checkbox" class="easyui-textbox" name="auto_unzip"></input>
                                </td>
                            </tr>

                            <tr>
                                <td>选择文件: (外部下载地址参数file=)</td>
                                <td><input readonly="" id="form-file" class="easyui-textbox" type="text" name="file" data-options="required:true"></input>
                                </td>
                            </tr>
