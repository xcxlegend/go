...
<body>
    ...
    <table id="tg" title="[应用] 文件历史" class="easyui-treegrid ContextMenu" style="width:700px;height:250px" data-options="
				url: '/rbac/dir/app',
				method: 'get',
				lines: true,
				rownumbers: true,
   ...
   <!--  <div id="file_menu" class="easyui-menu" style="width:120px;">
    ...
    <div id="syncwindow"></div>
    <div id="tb" style="height:auto">
        <a href="javascript:void(0)" id="fileButton" title="请选择union应用文件" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="uploadWindow()">Upload</a>
    ...
    <script type="text/javascript">
        ...
        $('#file').change(function () {
            ...
            $.ajaxFileUpload({
                url:'/rbac/dir/upload_app',   //处理图片的脚本路径
                type: 'post',       //提交的方式
        ...
        function sync(){
            ...
            $.post('/rbac/sync/sync_app', {dir: selectedRow.path}, function(res){
                if (!res.status){
